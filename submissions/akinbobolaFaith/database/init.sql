...
VALUES('R L Fit Oxford Button-Down Pony Logo Shirt-Skyblue', 'Ralph Lauren is the prinnacle of style and design. This classic fit oxford shirt is the perfect way to stay classy. A buttondown classic fit polo which is 100% cotton', 'https://github.com/faithakinbobola/Dufuna-CodeCamp20/blob/master/submissions/akinbobolaFaith/html/image/img_0367_1.jpg', 14000.00, 2, 4, 180, 'in stock', now()),
("Skechers Men's Blaine Orsen Ankle Boot", 'Approx. 1'' heel height, Approx. 5'' boot shaft height, Cushioned footbed, Dual side goring Fabric lining', 'https://github.com/faithakinbobola/Dufuna-CodeCamp20/blob/master/submissions/akinbobolaFaith/html/image/Skechers-Men-Blaine-Orsen-Ankle-Boot.jpg', 22000.00, 3, 1, 50, 'low stock', now()),
("UGG Men's Biltmore Chelsea Boot", 'Imported, Rubber sole, Shaft measures approximately ankle-high from arch, Waterproof full-grain leather upper, Energ comfort system insole, White spider rubber outsole for added traction, Fully waterproof and seam-sealed construction, Textile lining', 'https://github.com/faithakinbobola/Dufuna-CodeCamp20/blob/master/submissions/akinbobolaFaith/html/image/UGG-Men-Biltmore-Chelsea-Boot2.jpeg', 24999.00, 3, 2, 240, 'in stock', now()),
('Fendi Custom Fotted Ladies Gown-Black', 'Casual, meet smart, Polo collar, Button placket, Embroidered logo to chest, Fitted cuffs, Slim fit, A narrow cut that sits close to the body', 'https://github.com/faithakinbobola/Dufuna-CodeCamp20/blob/master/submissions/akinbobolaFaith/html/image/Fendi-Custom-Fotted-Ladies-Gown-Black.jpg', 20999.00, 1, 3, 0, 'out of stock', now());
