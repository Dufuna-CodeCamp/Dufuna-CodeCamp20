...
SELECT passengers.fullname, passengers.sex FROM passengers LEFT JOIN passengers_details ON passengers.id = passengers_details.passengers_id
...
SELECT passengers.id,passengers.fullname FROM passengers LEFT JOIN passengers_details ON passengers.id
